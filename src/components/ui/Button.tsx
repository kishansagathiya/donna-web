...
const variantClasses: Record<Variant, string> = {
  primary:
    "bg-donna-gold text-white hover:opacity-90 disabled:opacity-70",
  secondary:
    "bg-donna-surface text-donna-text border border-donna-border hover:border-donna-gold-ring",
  destructive:
    "bg-donna-destructive text-white hover:opacity-90 disabled:opacity-70",
  ghost:
    "bg-transparent text-donna-muted hover:text-donna-gold",
};
